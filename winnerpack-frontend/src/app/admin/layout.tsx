...
/>
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#ffebeb] font-sans text-[#0F1721] selection:bg-[#fe8220] selection:text-white relative">
      ...
      <aside className="w-20 my-4 ml-4 bg-[#120a3b]/95 flex flex-col items-center justify-between py-6 px-3 shrink-0 rounded-3xl border border-indigo-900/40 text-white z-40 no-scrollbar shadow-2xl">
...
/>
      ...
      <div className="admin-workspace-content flex-1 flex flex-col min-w-0 h-[calc(100vh-32px)] my-4 mx-4 bg-[#f8f7f4]/95 rounded-3xl border border-[#e5dfd2]/80 overflow-hidden relative shadow-2xl z-10 no-scrollbar">

        {/* MERGED SINGLE TOP EXECUTIVE HEADER */}
        <header className="px-8 py-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4 shrink-0 border-b border-[#e5dfd2]/80 bg-white/95 shadow-xs relative z-10">
...
/>
        ...
        <div className="px-8 py-3 overflow-x-auto no-scrollbar shrink-0 bg-white/90 border-b border-[#e5dfd2]/60 relative z-10">
