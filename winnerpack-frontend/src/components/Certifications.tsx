  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-8">
        ...
        {/* Centered Section Header - Identical Typography & Hierarchy to Trusted Brands */}
        ...
        {/* 2-Row Certification Logos Grid */}
        <div className="space-y-10 md:space-y-14">
          
          {/* Row 1 (6 Badges) */}
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-6 md:gap-8 items-center justify-items-center">
          ...
          {/* Row 2 (5 Badges) */}
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-6 md:gap-8 items-center justify-items-center max-w-5xl mx-auto">
