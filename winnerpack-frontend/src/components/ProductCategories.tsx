              ...
              >
                <Link href={`/product-category/${cat.id}`} className="block h-full w-full">
                  <div className="relative aspect-[4/3] sm:aspect-square w-full overflow-hidden bg-[var(--color-bone)]">
                    ...
                    <div
                      className={`absolute bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 transition-all duration-300 px-2.5 sm:px-4 py-1 sm:py-2 rounded-full bg-white/95 backdrop-blur-md text-[var(--color-ink)] text-[10px] sm:text-xs font-bold shadow-lg flex items-center gap-1 sm:gap-1.5 whitespace-nowrap border border-white/40 ${
                        isActive
                  ...
                  <div
                    className={`py-2.5 sm:py-4 px-2 sm:px-5 text-center border-t border-[var(--color-line)] min-h-[44px] sm:min-h-[64px] flex items-center justify-center transition-colors duration-300 ${
                      isActive ? "bg-[var(--color-amber-soft)]" : "bg-white group-hover:bg-[var(--color-mist)]"
                    }`}
                  >
                    <h3
                      className={`font-display text-xs sm:text-base font-bold tracking-tight transition-colors duration-300 leading-tight ${
                        isActive ? "text-[var(--color-amber-dark)] font-extrabold" : "text-[var(--color-ink)] group-hover:text-[var(--color-amber-dark)]"
                      }`}
                    >
                      {cat.title}
                    </h3>
