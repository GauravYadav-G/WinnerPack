        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            <p className="mt-5 text-xs sm:text-sm leading-relaxed text-white/60 text-justify">
              Winner Pack Technologies Private Limited is one of the leading manufacturers and suppliers of environment-friendly secondary and tertiary packaging materials and machinery. Guided by our motto "We Serve To Deserve", we supply high-quality stretch films, strapping rolls, shrink films, and packaging machinery from our Ghaziabad, UP base, dispatched across India and to global export markets.
            </p>
